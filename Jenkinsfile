    ...
    stages {
        ...
        stage('Create DB And Tables') {
            steps {
                ...
                sh 'kubectl exec deployments/mssql -n poc -- /opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P P4ssw0rd -Q "CREATE DATABASE demo ON (NAME=demo_dat,FILENAME=N\'/data/demo.mdf\') LOG ON (NAME=demo_log, FILENAME=N\'/data/demo.ldf\')"'
